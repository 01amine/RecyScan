...
class AuthRepositoryImpl implements AuthRepository {
  ...
  @override
  FutureOr<Either<Failure, void>> saveToken(String token) async {
    try {
  ...
  @override
  FutureOr<Either<Failure, String?>> getToken() async {
    try {
  ...
  @override
  FutureOr<Either<Failure, void>> clearToken() async {
    try {
  ...
  @override
  FutureOr<Either<Failure, User>> getCurrentUser() async {
    if (await networkInfo.isConnected) {
      try {
        final token = await localDataSource.getToken();
        if (token != null) {
  ...
  @override
  FutureOr<Either<Failure, void>> forgetPassword({
    required String email,
  }) async {
    if (await networkInfo.isConnected) {
      try {
  ...
  @override
  FutureOr<Either<Failure, void>> updateUser({
  ...
  @override
  FutureOr<Either<Failure, void>> deleteUser(String userId) async {
    if (await networkInfo.isConnected) {
      try {
        final token = await localDataSource.getToken();
        if (token != null) {
          await remoteDataSource.deleteUser(userId, token);
          await localDataSource.clearToken();
          return const Right(null);
        } else {
          return Left(CacheFailure());
